...
<template>
    <div class="flex lg:flex-row flex-col  items-center justify-center">
        ...
        <!-- RIGHT DIV -->
        <div class=" bg-gray-500 h-auto max-h-full w-11/12 lg:my-0 lg:mx-0 lg:w-2/3 lg:h-screen border border-primary-border rounded-lg lg:rounded-none container object-contain overflow-auto absolute lg:relative" v-if="!this.verification">
            ...
            <div class="flex flex-col p-2 lg:p-12 2xl:p-36 relative top-1/2 transform lg:-translate-y-1/2">
                ...
                <button class=" bg-primary-orange hover:bg-orange-800 text-white rounded-md h-10 w-24 my-2" @click="toggleVerification()">
                  Submit
                </button>
            </div>
        ...
        <!-- RIGHT DIV 3-->
        <div class=" bg-gray-500 h-4/5 w-4/5 mx-12 my-12 lg:my-0 lg:mx-0 lg:w-2/3 lg:h-screen border border-primary-border container absolute lg:relative" v-if="this.verification">
